...
public class BaseAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.iis.BaseAnnotation");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "edu.cmu.lti.iis.BaseAnnotation");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.cmu.lti.iis.BaseAnnotation");
